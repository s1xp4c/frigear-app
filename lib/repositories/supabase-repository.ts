...
export default class SupabaseRepository<Entity extends any, CreateParams extends any = Entity, UpdateParams extends any = Entity> implements IRepository<string, Entity, CreateParams, UpdateParams> {
    ...
    async deleteAll(): Promise<void> {
        const {error} = await this.client.from(this.tableName)
            .delete({count: 'exact'})
