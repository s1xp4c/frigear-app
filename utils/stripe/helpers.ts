...
export function transformStripeProduct(data: StripeWebhookEventData): Product {
    ...
    return {
        ...
        default_price_id: typeof default_price === 'string' ? default_price : default_price?.id || undefined,
        price: typeof default_price !== 'string' && default_price?.unit_amount ? default_price.unit_amount / 100 : undefined,
